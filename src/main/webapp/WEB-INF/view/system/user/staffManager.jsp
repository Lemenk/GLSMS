			...
			<div class="layui-form-item" style="margin-left: 150px">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="staId" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">姓名:</label>
					<div class="layui-input-inline">
						<input type="text" name="staName" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-inline">
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							...
							<input type="text" name="staName" lay-verify="required" placeholder="请输入工作人员姓名" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">编号:</label>
						<div class="layui-input-inline">
							<input type="text" name="staId" lay-verify="required"
								   placeholder="请输入工作人员编号" autocomplete="off" class="layui-input" id="staId">
						</div>
					</div>
				</div>
		...
		<script type="text/javascript">
			...
			layui.extend({
				...
				tableIns = table.render({
					...
					, url: '${pageContext.request.contextPath}/staff/loadAllStaff' //数据接口
					, title: '工作人员数据表'//数据导出来的标题
					...
					, cols: [[   //列表数据
						...
						, {field: 'staId', title: '工作人员编号', align: 'center', width: '150'}
						, {field: 'staName', title: '工作人员姓名', align: 'center', width: '130'}
						, {field: 'deptName', title: '所属部门', align: 'center', width: '230'}
				...
				$("#doSearch").click(function () {
					...
					tableIns.reload({
						url: "${pageContext.request.contextPath}/staff/loadAllStaff?" + params
					})
				});
				...
				$("#reset1").click(function () {
					...
					tableIns.reload({
						url: "${pageContext.request.contextPath}/staff/loadAllStaff"
					});
				});
				...
				table.on('tool(userTable)', function (obj) {
					...
					if (layEvent === 'del') { //删除
						layer.confirm('真的删除【' + data.staName + '】这个工作人员吗', function (index) {
							//向服务端发送删除指令
							$.post("${pageContext.request.contextPath}/staff/deleteStaff", {staId: data.staId}, function (res) {
								layer.msg(res.msg);
								//刷新数据 表格
								tableIns.reload();
							})
						...
						layer.confirm('真的重置【' + data.staName + '】这个工作人员的的密码吗', function (index) {
							//向服务端发送删除指令
							$.post("${pageContext.request.contextPath}/staff/resetUserPwd", {staId: data.staId}, function (res) {
								layer.msg(res.msg);
							})
						});
					}
				...
				//部门下拉列表
				$.get("${pageContext.request.contextPath}/dept/loadStaDept",function(objs){
					var depts=objs.data;
					var dept=$("#deptName");
					var dept1=$("#deptName1");

        ...
        <form class="layui-form" method="post" id="searchFrm">
            ...
            <div class="layui-form-item" style="text-align: center;margin-right: 40px">
                <div class="layui-input-block">
                    ...
                    <button type="reset" class="layui-btn layui-btn-warm  layui-icon layui-icon-refresh" id="reset1">
                        重置
                    </button>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            layui.use(['jquery', 'layer', 'form', 'table', 'laydate', 'layedit'], function () {
                ...
                tableIns = table.render({
                    ...
                    , url: '${pageContext.request.contextPath}/news/loadAllNews' //数据接口
                ...
                $("#doSearch").click(function () {
                    ...
                    tableIns.reload({
                        url: "${pageContext.request.contextPath}/news/loadAllNews?" + params,
                        page: {curr: 1}
                    })
                });
                ...
                $("#reset1").click(function () {
                    tableIns.reload({
                        url: "${pageContext.request.contextPath}/news/loadAllNews"
                    });
                });
                ...
                table.on('tool(newsTable)', function (obj) {
                    ...
                    if (layEvent === 'del') { //删除
                        layer.confirm('真的删除【' + data.title + '】这个公告吗', function (index) {
                            //向服务端发送删除指令
                            $.post("${pageContext.request.contextPath}/news/deleteNews", {id: data.id}, function (res) {
                                layer.msg(res.msg);
                                //刷新数据 表格
                                tableIns.reload();
                            })
                ...
                function deleteBatch() {
                    ...
                    layer.confirm('真的删除选中的这些公告吗', function (index) {
                        //向服务端发送删除指令
                        $.post("${pageContext.request.contextPath}/news/deleteBatchNews", params, function (res) {
                            layer.msg(res.msg);
                            //刷新数据 表格
                            tableIns.reload();
                        })

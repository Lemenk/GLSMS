		...
		<form class="layui-form"  lay-filter="dataFrm" id="dataFrm">
			<div class="layui-form-item">
				  <label class="layui-form-label">父级菜单：</label>
				   <div class="layui-input-block">
				      <div class="layui-unselect layui-form-select" id="parentId_div">
				        <div class="layui-select-title">
				          <input type="hidden" name="parentId"  id="parentId">
				          <input type="text" name="parentId_str" id="parentId_str" placeholder="请选择" lay-verify="required" readonly="" class="layui-input layui-unselect">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<button type="button" class="layui-btn layui-btn-normal" onclick="window.open('https://www.layui.com/doc/element/icon.html','_blank')" >去官网</button>
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-inline">
	    ...
	    layui.extend({
			 ...
			 tableIns=table.render({
			    ...
			    ,cols: [[   //列表数据
			     {type: 'checkbox', fixed: 'left'}
			      ...
			      ,{field:'parentId', title:'父节点ID',align:'center',width:'100'}
		   ...
		   table.on('tool(menuTable)', function(obj){
				  ...
				  $.post("${pageContext.request.contextPath}/menu/checkMenuHasChildren?id="+data.id,function(obj){
					  if(obj.code>=0){
						  ...
						  layer.confirm('真的删除【'+data.title+'】这个菜单吗', function(index){
						       //向服务端发送删除指令
						       $.post("${pageContext.request.contextPath}/menu/deleteMenu",{id:data.id},function(res){
						    	   layer.msg(res.msg);
						    	    //刷新数据 表格
									tableIns.reload();
									//刷新左边的树
			...
			function openUpdateMenu(data){
				mainIndex=layer.open({
					...
					success:function(index){
					    ...
					    var params = dtree.dataInit("menuTree", parentId);
					    //移除打开的样式
					    $("#menuSelectDiv").removeClass("layui-show");
					    //给下拉框的text框赋值
					    $("#parentId_str").val(params.context);
					}
				});
			}
			//保存
			...
			var menuTree = dtree.render({
				...
				$("#parentId_div").on("click",function(){
				  $(this).toggleClass("layui-form-selected");
				  $("#menuSelectDiv").toggleClass("layui-show layui-anim layui-anim-upbit");
				});
				dtree.on("node(menuTree)", function(obj){
				  $("#parentId_str").val(obj.param.context);
				  $("#parentId").val(obj.param.nodeId);
				  $("#parentId_div").toggleClass("layui-form-selected");
				  $("#menuSelectDiv").toggleClass("layui-show layui-anim layui-anim-upbit");
				});

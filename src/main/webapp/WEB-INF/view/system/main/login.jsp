...
<body class="loginBody">
	<form class="layui-form" id="loginFrm" method="post" action="${pageContext.request.contextPath}/login/login">
		<%--<div class="login_face"><img src="${pageContext.request.contextPath}/resources/images/face.jpg" class="userAvatar"></div>--%>
			<div class="auth_tab_links" style="margin-top: 25px">
				<ul>
					<li id="accountLogin" style="width:100%;" class="selected" tabid="01">
						<img src="${pageContext.request.contextPath}/resources/images/login.png" alt="">
					</li>
				</ul>
			</div>
		<div class="layui-form-item input-item" style="margin-top: 20px">
			<label for="userName">用户名</label>
			<input type="text" placeholder="请输入学号/职工号" autocomplete="off" id="userName" name="username" class="layui-input" lay-verify="required">
		</div>
		...
		<div class="layui-form-item input-item" id="imgCode">
			...
			<img src="${pageContext.request.contextPath}/login/getCode" onclick="this.src=this.src+'?'">
		</div>

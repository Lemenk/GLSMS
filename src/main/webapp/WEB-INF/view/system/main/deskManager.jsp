    ...
    <body class="childrenBody">
        ...
        <script type="text/javascript">
            ...
            function getLangDate(){
                ...
                document.getElementById("nowTime").innerHTML = timeValue+ "好！ 欢迎使用毕业生离校管理系统。当前时间为： "+newDate+"　"+week;
            ...
            layui.use(['form','element','layer','jquery'],function(){
                ...
                //最新文章列表
                $.get("${pageContext.request.contextPath}/news/loadAllNews?page=1&limit=10",function(data){
                    var hotNewsHtml = '';
                    var dlength = data.data.length;
                    for(var i=0;i<dlength;i++){
                        hotNewsHtml +=
                            '<tr onclick=viewNews('+data.data[i].id+')>'
            ...
            function viewNews(id){
                $.get("${pageContext.request.contextPath}/news/loadNewsById",{id:id},function(news){
                    layer.open({
                        type:1,
                        title:'查看公告',

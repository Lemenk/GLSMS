        ...
        <div class="layui-layout layui-layout-admin">
                    ...
                    <ul class="layui-nav top_menu">
                        ...
                        <li class="layui-nav-item" id="userInfo">
                            ...
                            <dl class="layui-nav-child">
                                <dd><a id="ziliao" href="javascript:"
                                       data-url=""><i class="seraph icon-ziliao"
                                ...
                                <dd><a href="javascript:" class="showNotice"><i class="layui-icon">&#xe645;</i><cite>系统公告</cite><span
                                        class="layui-badge-dot"></span></a></dd>
                                <dd><a href="${pageContext.request.contextPath}/login/toLogin" class="signOut"><i
            ...
            <div class="layui-side layui-bg-black">
                <div class="user-photo">
                    <p><span class="userName layui-icon">&#xe612; ${role}</span></p>
                    <p>你好！<b><span class="userName">${name}</span></b>, 欢迎登录</p>
                </div>
                <!-- 搜索 -->
                ...
                <div class="navBar layui-side-scroll" id="navBar">
                    <ul class="layui-nav layui-nav-tree">
                        <li class="layui-nav-item layui-this">
                            <a href="javascript:;" data-url="/desk/toDeskManager"><i class="layui-icon"
            ...
            <div class="layui-footer footer">
                <p><span>copyright @2020 Lemenk</span></p>
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
                ...
                $(function () {
                    ...
                    if (role === '学生') {
                        $("#ziliao").attr("data-url", "${pageContext.request.contextPath}/sys/toStudentInfo");
                    } else if (role === '教师') {
                        $("#ziliao").attr("data-url", "${pageContext.request.contextPath}/sys/toTeacherInfo");
                    } else if (role === '工作人员') {
                        $("#ziliao").attr("data-url", "${pageContext.request.contextPath}/sys/toStaffInfo");
                    } else {
                        $("#ziliao").hide();
                    }
                });

...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/glsms?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
        ...
        */
        ...
        //去掉表的前缀
        strategy.setTablePrefix("sys_","tb_","comm_");
        mpg.setStrategy(strategy);
        //mpg.setTemplateEngine(new FreemarkerTemplateEngine());
        mpg.execute();
        System.out.println("生成完成，请检查文件。");
    }
